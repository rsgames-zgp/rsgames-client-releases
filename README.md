...
| Platform | File |
|---|---|
| **Windows** | `rsg-windows-x86_64.exe` |
| **macOS (Apple Silicon — M1/M2/M3/M4)** | `rsg-mac-arm64.dmg` |
| **macOS (Intel)** | `rsg-mac-x86_64.dmg` |
| **Linux x86_64** | `rsg-linux-x86_64.tar.gz` |

## Beta builds

If you are in the RSGames beta team, access to our beta releases will be granted on a 1-1 need. If you are not yet on the RS Beta team, information on how to join may be on our website in the future.
